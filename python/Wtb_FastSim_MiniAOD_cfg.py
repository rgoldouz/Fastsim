...
# with command line options: step1 --filein dbs:/VBF-C1N2_leptonicDecays_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16FSPremix-80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/AODSIM --fileout file:SUS-RunIISummer16MiniAODv2-00097.root --mc --eventcontent MINIAODSIM --runUnscheduled --fast --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename SUS-RunIISummer16MiniAODv2-00097_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1920
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/user/rgoldouz/WtbPhenomenology/CMSSW_8_0_21/src/Fastsim/Wtb_FastSim.root'), 
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Wtb_FastSim_MiniAOD.root'),
